...
## Overview
The primary goal of this project was to learn the practical process of creating a simple PCB from the design to the finished working device. It is based off the theory learned in Introduction to Electronics course offered at the University of Oulu and manufactured at the university Fab Lab.
